...
export default function ConsoleLayout({ onBack, onFindings, onRedTeam, onRunAudit }: ConsoleLayoutProps) {
  ...
  return (
    <div className="h-screen bg-black text-white font-mono flex flex-col overflow-hidden">
      ...
      <div className="pt-16 md:pt-20 flex-1 flex overflow-hidden">
        <Sidebar onFindings={onFindings} onRedTeam={onRedTeam} onRunAudit={onRunAudit} />
